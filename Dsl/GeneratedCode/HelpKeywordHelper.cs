...
namespace Company.RICT
{
	...
	/// </remarks>
	public partial class RICTHelpKeywordHelper : RICTHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new RICTHelpKeywordHelper.
		/// </summary>
		protected RICTHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the RICTHelpKeywordHelper.
		/// </summary>
		public static RICTHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class RICTHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new RICTHelpKeywordHelperBase.
		/// </summary>
		protected RICTHelpKeywordHelperBase()
			: base() { }
