...
namespace Company.RICT
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.RICTEditorFactoryId)]
	internal partial class RICTEditorFactory : RICTEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new RICTEditorFactory.
		/// </summary>
		public RICTEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RICTEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected RICTEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new RICTDocData(this.ServiceProvider, typeof(RICTEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new RICTDocView(docData, this.ServiceProvider);
		}
	}
}
