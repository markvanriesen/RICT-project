...
namespace Company.RICT
{
	...
	/// </summary>
	internal partial class RICTCommandSet : RICTCommandSetBase
	{
		/// <summary>
		/// Constructs a new RICTCommandSet.
		/// </summary>
		public RICTCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class RICTCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new RICTCommandSetBase.
		/// </summary>
		protected RICTCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewRICTExplorerCommand,
				typeof(RICTEditorFactory).GUID);
		...
		{
			RICTExplorerToolWindow explorer = this.RICTExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected RICTDocData CurrentRICTDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as RICTDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected RICTDocView CurrentRICTDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as RICTDocView;
			}
		}
		...
		/// </summary>
		protected RICTExplorerToolWindow RICTExplorerToolWindow
		{
			get
			{
				RICTExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(RICTExplorerToolWindow), true) as RICTExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				RICTExplorerToolWindow explorerWindow = this.RICTExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class RICTClipboardCommandSet : RICTClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new RICTClipboardCommandSet.
		/// </summary>
		public RICTClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class RICTClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new RICTClipboardCommandSetBase.
		/// </summary>
		protected RICTClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
